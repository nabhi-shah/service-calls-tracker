...
export default function ServiceCallsTab({ calls, brokers, onSave }) {
  ...
  const cols = [
    ...
    { key: 'callDate',        label: 'Call Date',        w: 'w-36' },
    { key: 'callLocation',    label: 'Location',         w: 'w-52' },
    { key: 'address',         label: 'Address',          w: 'w-48' },
    { key: 'broker',          label: 'Broker',           w: 'w-44' },
    { key: 'brokerContact',   label: 'Broker Contact',   w: 'w-36' },
    { key: 'locationContact', label: 'Loc. Contact',     w: 'w-36' },
    { key: 'resolutionDate',  label: 'Resolution Date',  w: 'w-36' },
    { key: 'resolutionNotes', label: 'Resolution Notes', w: 'w-52' },
    { key: 'status',          label: 'Status',           w: 'w-40' },
    { key: 'parts',           label: 'Parts',            w: 'w-48' },
    { key: 'machine',         label: 'Machine',          w: 'w-44' },
